<?php
require_once(str_replace('\\\\','/',dirname(__FILE__)).'/../../includes/config.php');
...
*/
SpawConfig::setStaticConfigItem('SPAW_DIR', $config['path']['http'].'/spaw2/');
/*
...
// toolbarset 
SpawConfig::setStaticConfigItem('default_toolbarset',$config['spaw']['toolbar']);
// stylesheet
SpawConfig::setStaticConfigItem('default_stylesheet',SpawConfig::getStaticConfigValue('SPAW_DIR').'../style/spaw.css');
// width 
